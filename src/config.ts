...
export const themeConfig: ThemeConfig = {
  ...
  seo: {
    // @twitter ID
    twitterID: '@clearluvmoki',
    // site verification
    verification: {
      // google search console
      // https://search.google.com/search-console
      google: 'Hr-GDh5WcAMP7ktb5MEJV3cDPFLogUbvPUnB_q--h6c',
    ...
    umamiAnalyticsID: 'a6b0f31d-cd50-4adc-ba32-7b85ae4d8bee',
    // follow verification
    // https://follow.is/
    follow: {
      // feed ID
  ...
  footer: {
    ...
    links: [
      {
        name: 'GitHub',
        url: 'https://github.com/ClearLuvMoki',
      },
      {
        name: 'Email',
        url: '2893096286@qq.com',
      },
    ],
    startYear: 2017,
  },
