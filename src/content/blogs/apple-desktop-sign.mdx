...
author: 徐牧之
img: https://moki-web.oss-cn-chengdu.aliyuncs.com/images/blogs/electron-mac.png
...
<FigureRow items={[
  { src: "https://moki-web.oss-cn-chengdu.aliyuncs.com/images/blogs/create-signing-request.png", alt: "Create SigningRequest" },
  { src: "https://moki-web.oss-cn-chengdu.aliyuncs.com/images/blogs/save-signing-request.png", alt: "Save SigningRequest" },
]} />
...
<FigureRow items={[
  { src: "https://moki-web.oss-cn-chengdu.aliyuncs.com/images/blogs/mac-certification-create.png", alt: "Create SigningRequest" },
]} />
...
+ 检查上述证书中对应的*Relations证书*是否齐全，在钥匙串中双击对应证书查看*Relations证书*:
	...
	+ 可能存在`unable to build chain to self-signed root for signer`等报错，或者导入了`Relations`证书还是无法使用上述的证书，请尝试下载并在**钥匙串**的**系统**中导入下方
